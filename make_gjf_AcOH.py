...
f.write("%Chk=C:\usr\n")
for i in range(361):
    fname = "confamb_Ac" + str(a + i) + ".inpcrd"
    n = 0
    ...
    for f1 in open(fname,"r"):
        ...
        if n == 2:
            ...
            f.write("C2     "+str(x[0])+" "+str(x[1])+" "+str(2)+"  \n")
            f.write("H2     "+str(x[3])+" "+str(x[4])+" "+str(5)+"  \n")
        elif n == 5:
            f.write("H3     "+str(x[0])+" "+str(x[1])+" "+str(2)+"  \n")
            f.write("H4     "+str(x[3])+" "+str(x[4])+" "+str(5)+"  \n\n")
            f.write("--Link1--\n")
        n += 1
f.close()
